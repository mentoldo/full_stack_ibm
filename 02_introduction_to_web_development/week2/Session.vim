...
silent only
silent tabonly
cd ~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 26 + 97) / 195)
exe 'vert 2resize ' . ((&columns * 168 + 97) / 195)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
10
normal! 0
lcd ~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2
wincmd w
argglobal
if bufexists("~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2/my_first_page/index.html") | buffer ~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2/my_first_page/index.html | else | edit ~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2/my_first_page/index.html | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 168 + 97) / 195)
tabnext 1
badd +0 ~/Escritorio/full_stack_ibm/02_introduction_to_web_development/week2/my_first_page/index.html
